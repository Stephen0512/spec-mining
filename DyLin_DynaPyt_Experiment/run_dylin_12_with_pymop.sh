...
CLONE_DIR="${DEVELOPER_ID}-${TESTING_REPO_NAME}_DyLin_12_with_pymop"
...
SOURCE_DIR="$PWD/../Specs_with_PyMOP/DyLin"
...
cp "$PWD/../Specs_with_PyMOP/select_checkers.py" "$PWD/DyLin/src/dylin/select_checkers.py"
